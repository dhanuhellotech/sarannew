...
export default function TourModel() {
                            ...
                            <tr key={model._id}>
                                ...
                                <td>
                                    {editingTourModelId === model._id ? (
                                        ...
                                        <button className="btn btn-primary ms-2 mr-2" style={{backgroundColor:'#0D2259'}} onClick={() => handleEditTourModel(model._id, model.tourPackagename)}>Edit</button>
                                    )}
                                    <button className="btn btn-warning ms-2" onClick={() => handleDeleteTourModel(model._id)}>Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
